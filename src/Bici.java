public class Bici implements ITranportable{
     ...
     * Lo compara con outro @param codigoPostal
     * @return Float reference ao coste total do envio
     */
     ...
     *
     * @param dX lonxitude do paquete
     * @param dY altura do paquete
     * @param dZ ancho do paquete
     *
     * @param peso peso do paquete
     *
     * @return Integer que indicará o tipo do embalaxe do paquete
     */
    @Override
